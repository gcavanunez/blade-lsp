...
export const bladeDirectives: BladeDirective[] = [
  // Conditionals
  {
    name: "@if",
  ...
  },
  {
    ...
    snippet: "@canany(['${1:ability1}', '${2:ability2}']${3:, ${4:\\$model}})\n\t$0\n@endcanany",
    hasEndTag: true,
    endTag: "@endcanany",
 ...
 */
export const directiveMap = new Map<string, BladeDirective>(
  bladeDirectives.map((d) => [d.name, d])
);

/**
 * Get directives that match a given prefix
 */
export function getMatchingDirectives(prefix: string): BladeDirective[] {
  const lowerPrefix = prefix.toLowerCase();
  return bladeDirectives.filter((d) =>
